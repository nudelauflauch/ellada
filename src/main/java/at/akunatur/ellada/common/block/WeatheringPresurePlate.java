...
public class WeatheringPresurePlate extends PresureplateBlock
		implements
			WeatheringBlock {
	private WeatheringBlock.WeatherState weatherState;
	
	public WeatheringPresurePlate(WeatheringBlock.WeatherState block,
			Sensitivity sensitivity, Properties properties) {
