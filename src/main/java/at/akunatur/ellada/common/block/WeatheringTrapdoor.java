...
public class WeatheringTrapdoor extends TrapDoorBlock implements WeatheringBlock {

	private final WeatheringBlock.WeatherState weatherState;

	public WeatheringTrapdoor(WeatheringBlock.WeatherState block, BlockBehaviour.Properties proberties) {
		super(proberties);
